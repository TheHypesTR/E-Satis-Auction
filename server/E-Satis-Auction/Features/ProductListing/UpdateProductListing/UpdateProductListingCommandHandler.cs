...
public sealed class UpdateProductListingCommandHandler : ICommandHandler<UpdateProductListingCommand, AdminProductListingDetailDto>
{
    ...
    public UpdateProductListingCommandHandler(
    ...
    public async Task<AdminProductListingDetailDto> Handle(UpdateProductListingCommand command, CancellationToken cancellationToken)
    {
        ...
        listing!.UpdatePrice(command.Price, command.Currency);
        listing.UpdateAvailability(command.ActiveFrom, command.ActiveUntil);

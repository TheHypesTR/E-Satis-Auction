...
public sealed class RelistAuctionCommandHandler : ICommandHandler<RelistAuctionCommand, AuctionDetailDto>
{
    private readonly IAuctionRepository _auctionRepository;
    private readonly IProductRepository _productRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RelistAuctionCommandHandler(IAuctionRepository auctionRepository, IProductRepository productRepository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<AuctionDetailDto> Handle(RelistAuctionCommand command, CancellationToken cancellationToken)
    {
        ...
        auction!.Relist(command.Payload.StartsAt, command.Payload.EndsAt);

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapacityM3 = table.Column<double>(type: "double precision", nullable: false),
                    CriticalThresholdM3 = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseAttributes = table.Column<Dictionary<string, string>>(type: "jsonb", nullable: false, defaultValueSql: "'{}'::jsonb"),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetFacilityId = table.Column<Guid>(type: "uuid", nullable: true),
                    TargetAddressId = table.Column<Guid>(type: "uuid", nullable: true),
                    ReceiverName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ReceiverPhone = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    Notes = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    DeliveryNote = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    DispatchDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dispatches_Addresses_TargetAddressId",
                        column: x => x.TargetAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dispatches_Facilities_SourceFacilityId",
                        column: x => x.SourceFacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Dispatches_Facilities_TargetFacilityId",
                        column: x => x.TargetFacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FacilityManagers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    DynamicAttributes = table.Column<Dictionary<string, string>>(type: "jsonb", nullable: false, defaultValueSql: "'{}'::jsonb"),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispatchLineItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispatchLineItems_Dispatches_DispatchId",
                        column: x => x.DispatchId,
                        principalTable: "Dispatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DispatchLineItems_Items_SourceItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_City_District",
                table: "Addresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAttributeOptions_CategoryAttributeId_Value",
                table: "CategoryAttributeOptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dispatches_SourceFacilityId",
                table: "Dispatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dispatches_TargetAddressId",
                table: "Dispatches",
                column: "TargetAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispatches_TargetFacilityId",
                table: "Dispatches",
                column: "TargetFacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispatches_TrackingNumber",
                table: "Dispatches",
                column: "TrackingNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DispatchLineItems_DispatchId",
                table: "DispatchLineItems",
                column: "DispatchId");

            migrationBuilder.CreateIndex(
                name: "IX_DispatchLineItems_SourceItemId",
                table: "DispatchLineItems",
                column: "SourceItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityManagers_UserId",
                table: "FacilityManagers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_DynamicAttributes",
                table: "Items",
                column: "DynamicAttributes")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_BaseAttributes",
                table: "Products",
                column: "BaseAttributes")
                .Annotation("Npgsql:IndexMethod", "gin");

...
using e_Sat_Auction.Features.Category.ActivateCategory;
using e_Sat_Auction.Features.Category.AddCategory;
using e_Sat_Auction.Features.Category.AddCategoryAttribute;
using e_Sat_Auction.Features.Category.AddCategoryAttributeOption;
using e_Sat_Auction.Features.Category.DeactivateCategory;
using e_Sat_Auction.Features.Category.DeleteCategoryAttribute;
using e_Sat_Auction.Features.Category.DeleteCategoryAttributeOption;
using e_Sat_Auction.Features.Category.GetAllCategories;
using e_Sat_Auction.Features.Category.GetCategoryById;
using e_Sat_Auction.Features.Category.UpdateCategory;
using e_Sat_Auction.Features.Category.UpdateCategoryAttribute;
using e_Sat_Auction.Features.Category.UpdateCategoryAttributeOption;
